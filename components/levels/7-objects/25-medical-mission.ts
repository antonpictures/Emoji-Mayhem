...
export const level25: Level = {
    ...
    breakableBlocks: [
        ...
        { id: 'l25p1', position: { x: 150, y: 550 }, width: 250, height: 20, health: 100 },
        { id: 'l25p2', position: { x: 300, y: 450 }, width: 150, height: 20, health: 100 },
        { id: 'l25p3', position: { x: 950, y: 550 }, width: 200, height: 20, health: 100 },
        { id: 'l25p4', position: { x: 900, y: 300 }, width: 150, height: 20, health: 100 },
    ],
    emojiStructures: [
