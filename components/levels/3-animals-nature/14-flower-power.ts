...
export const level14: Level = {
    ...
    platforms: [
        {id: 'l14p1', position: {x: 100, y: 550}, width: 100, height: 20 },
        {id: 'l14p2', position: {x: 200, y: 450}, width: 100, height: 20 },
        {id: 'l14p3', position: {x: 300, y: 350}, width: 100, height: 20 },
        {id: 'l14p4', position: {x: 1050, y: 550}, width: 100, height: 20 },
        {id: 'l14p5', position: {x: 950, y: 450}, width: 100, height: 20 },
    ],
    breakableBlocks: [
