...
export const level17: Level = {
    ...
    platforms: [
      // Left Stage
      { id: 'l17p1', position: { x: 200, y: 550 }, width: 150, height: 20 },
      { id: 'l17p2', position: { x: 250, y: 450 }, width: 150, height: 20 },
      { id: 'l17p3', position: { x: 350, y: 350 }, width: 100, height: 20 },

      // Right Stage
      { id: 'l17p4', position: { x: 1000, y: 550 }, width: 150, height: 20 },
      { id: 'l17p5', position: { x: 950, y: 450 }, width: 150, height: 20 },
      { id: 'l17p6', position: { x: 850, y: 550 }, width: 100, height: 20 },
    ],
    emojiStructures: [
