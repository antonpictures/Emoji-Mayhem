...
export const level35: Level = {
    ...
    platforms: [
        // Ice castle structure
        { id: 'l35p1', position: { x: 900, y: 250 }, width: 200, height: 20 }, // Elsa's platform
        { id: 'l35p2', position: { x: 900, y: 450 }, width: 100, height: 20 }, // Ice block's platform
        { id: 'l35p3', position: { x: 750, y: 550 }, width: 100, height: 20 }, // Olaf's platform
    ],
    breakableBlocks: [
