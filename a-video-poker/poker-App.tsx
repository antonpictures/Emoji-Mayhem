...
const VideoPokerGame: React.FC<VideoPokerGameProps> = ({ onBackToTitle }) => {
    ...
    return (
        <div className="min-h-screen text-white flex flex-col items-center p-1 sm:p-2 selection:bg-brand-yellow selection:text-black">
            <main className="w-full max-w-md mx-auto flex flex-col items-center">
                ...
                <a href="https://pump.fun/coin/6PHhkb9GNDTp6tsfr9EsZvJjyssxn8yi4HpPnqNvpump" target="_blank" rel="noopener noreferrer" className="block w-full my-2 p-3 bg-yellow-500 text-black font-bold text-center rounded-lg shadow-lg hover:bg-yellow-400 transition-colors animate-pop-in">
                    BUY $MPS Google Maps Coin on Solana to support Google Maps Games!
                </a>
                    ...
                    <div className="flex w-full space-x-2 mt-6">
                        {onBackToTitle && (
                            <button 
                                ...
                                className="w-full bg-red-600 text-white font-bold py-3 px-4 rounded-xl hover:opacity-90 transition-opacity duration-200"
                            >
                                MAIN MENU
                            </button>
                        )}
                        <button 
                            ...
                            className="w-full bg-brand-yellow text-brand-dark-bg font-bold py-3 px-4 rounded-xl hover:opacity-90 transition-opacity duration-200"
                        >
                            Restart Simulation
                        </button>
                    </div>
